...
class ConvS2S(LitSeq2Seq):
    ...
    Both encoder and decoder are stacks of 1-D convolutions with GLU
    activations and residual connections; the decoder attends to the encoder
    ...
    Note on incremental decoding:
        ...
        K depends on the previous K-1 hidden activations of the layer below,
